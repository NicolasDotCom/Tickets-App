...
export default function DeleteUser() {
    ...
    // Solo mostrar la opción de eliminar cuenta si el usuario es administrador
    if (!isAdmin()) {
        return (
            <div className="space-y-6">
                <HeadingSmall title="Eliminar cuenta" description="Elimina tu cuenta y todos sus recursos" />
                <div className="space-y-4 rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-200/10 dark:bg-yellow-700/10">
                    <div className="relative space-y-0.5 text-yellow-700 dark:text-yellow-100">
                        <p className="font-medium">Acción Restringida</p>
                        <p className="text-sm">
